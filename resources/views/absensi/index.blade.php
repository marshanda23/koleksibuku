...
<head>
    ...
    <title>Sistem Absensi NFC</title>
    <link rel="stylesheet" href="{{ asset('assets/vendors/mdi/css/materialdesignicons.min.css') }}">
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: sans-serif; background: #f5f3ff; padding: 24px; }
        ...
        #status { font-size: 13px; color: #9ca3af; margin-bottom: 10px; min-height: 20px; }
        #status-sim { font-size: 13px; color: #9ca3af; margin-bottom: 10px; min-height: 20px; }
...
async function aktifkanNFC() {
    ...
    try {
        ...
        area.style.background = 'linear-gradient(135deg, #ede9fe, #ddd6fe)';
