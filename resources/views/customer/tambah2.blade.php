...
<div class="page-header">
    <h3 class="page-title">
        ...
        <span class="text-muted" style="font-size:0.8rem;">Customer /</span> Tambah Customer 2 (File)
    </h3>
</div>
...
<div class="card shadow-sm border-0" style="border-radius:15px;">
    <div class="card-header bg-white fw-bold" style="color:#7243a1;border-bottom:2px solid #b66dff;">
        <i class="mdi mdi-folder-image me-2"></i>Form Tambah Customer - Simpan Foto sebagai FILE
    </div>
    ...
    <form action="{{ route('customer.store2') }}" method="POST" id="formFile">
    @csrf
    <input type="hidden" name="foto"              id="foto_blob">
